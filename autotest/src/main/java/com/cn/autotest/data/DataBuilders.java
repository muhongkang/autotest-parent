...
import com.cn.autotest.dao.CRUDData;
...
public class DataBuilders {
    ...
    public static String dataprovide(String var) throws Exception {
        String value = "";
    ...
    //根据caseNo进行接口请求
    public static String runCase(Matcher matcher) throws Exception {
        ...
        String requestType = caseMess[2]; //请求类型post/gets
